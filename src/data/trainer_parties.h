...
static const struct TrainerMon sParty_WISE_OLD_MAN_1[] = { //LUMBRIDGE FOREST
    ...
    .ability = ABILITY_MAGIC_BOUNCE,
    .nature = NATURE_MODEST,
    .moves = {MOVE_CONFUSION, MOVE_THUNDER_WAVE, MOVE_POWDER_SNOW, MOVE_PSYCHIC_TERRAIN},
    .ev = TRAINER_PARTY_EVS(4, 0, 0, 252, 0, 252),
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 15,
    .species = SPECIES_PURE,
...
static const struct TrainerMon sParty_ALKHARID_GYM_TRAINER_1[] = {
    {
    .lvl = 40,
    .species = SPECIES_KALPHITE_WORKER_FORM,
    .heldItem = ITEM_NONE
    },
    {
    .lvl = 41,
...
static const struct TrainerMon sParty_ALKHARID_GYM_TRAINER_2[] = {
    {
    .lvl = 44,
    ...
    {
    .lvl = 43,
    .species = SPECIES_CAMEL,
    .heldItem = ITEM_NONE
    }
};

static const struct TrainerMon sParty_ALKHARID_GYM_TRAINER_3[] = {
    {
    .lvl = 41,
    .species = SPECIES_GOAT_DESERT_FORM,
    .heldItem = ITEM_NONE
    ...
    {
    .lvl = 42,
    .species = SPECIES_STRYKEWYRM_SANDY_FORM,
    .heldItem = ITEM_NONE
    },
    {
    .lvl = 43,
...
static const struct TrainerMon sParty_ALKHARID_GYM_TRAINER_4[] = {
    {
    .lvl = 42,
    .species = SPECIES_WOLF_DESERT_FORM,
    .heldItem = ITEM_NONE
    ...
    {
    .lvl = 42,
    .species = SPECIES_KALPHITE_PARAGON_FORM,
    .heldItem = ITEM_NONE
    },
    {
    .lvl = 43,
    ...
    {
    .lvl = 43,
    .species = SPECIES_KALPHITE_MARAUDER_FORM,
    .heldItem = ITEM_NONE
    }
};
...
static const struct TrainerMon sParty_DraynorManor_HAM[] = {
    ...
    .lvl = 17,
    .species = SPECIES_GIANT_RAT_NORMAL_FORM,
    .moves = {MOVE_BITE, MOVE_TAUNT, MOVE_POISON_FANG, MOVE_SUPER_FANG}
    },
    {
    .lvl = 18,
    .species = SPECIES_CHICKEN_BANDOSIAN_FORM,
