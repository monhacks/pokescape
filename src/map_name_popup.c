...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_TAVERLEY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BARBARIAN_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EDGEVILLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ALKHARID] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MUSA_POINT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GOBLIN_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DWARVEN_MINES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUMBRIDGE_SWAMP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MILL_LANE_MILL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DRAYNOR_MANOR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MUDSKIPPER_POINT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DUNGEON_SINKHOLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RIMMINGTON_MINES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ABYSS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GRAND_EXCHANGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CRANDOR] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ICE_MOUNTAIN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GROTTO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUMBRIDGE_SWAMP_CAVES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BAY_OF_SARIM] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MUDSKIPPER_SOUND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DAEMONHEIM] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_49] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_0] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_200] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WILDERNESS_CRATER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WILDERNESS_FOREST] = MAPPOPUP_THEME_WOOD,
