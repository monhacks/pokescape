...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[LOOT_POCKET].itemSlots = gSaveBlock1Ptr->bagPocket_Loot;
    gBagPockets[LOOT_POCKET].capacity = BAG_LOOT_COUNT;

    gBagPockets[RUNES_POCKET].itemSlots = gSaveBlock1Ptr->bagPocket_Runes;
    gBagPockets[RUNES_POCKET].capacity = BAG_RUNES_COUNT;
}
...
static void ShowItemIconSprite(u16 item, bool8 firstTime, bool8 flash)
{
    ...
    {
        //gSprites[spriteId2].x2 = x;   //to check commented out for now
        //gSprites[spriteId2].y2 = y;   //to check commented out for now
