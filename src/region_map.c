...
//F2P Map    
    ...
    [MAPSEC_MOR_UL_REK] = {MAP_GROUP(MOR_UL_REK), MAP_NUM(MOR_UL_REK), HEAL_LOCATION_MOR_UL_REK},
//Wilderness Map
...
//PokeScape
    ...
    case MAPSEC_MOR_UL_REK:
        return FlagGet(FLAG_VISITED_MOR_UL_REK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    if (gMapHeader.region == REGION_F2P)
    {
        ...
        for (mapSecId = MAPSEC_LUMBRIDGE; mapSecId <= MAPSEC_MOR_UL_REK; mapSecId++)
        {
