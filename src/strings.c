...
const u8 gText_QuestFollowerCannotDoThatMessage[] = _("Demonheadge's advice…\nYou cannot do this with that follower.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBalls[] = _("I'll throw in some regular Pouches, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Post_HAMHIDEOUT[] =_("POST HAMHIDEOUT");
...
const u8 gText_SideQuestDesc_AngrenouilleQuest[] = _("Who is this mysterious,\nyet dashing rogue?");
...
const u8 gText_SubQuest_AngrenouilleQuest_Desc7[] = _("Angrenouille fails to steal his\nmost valuable prize yet.\nThe Queen's heart.");
