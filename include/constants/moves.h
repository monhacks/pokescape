...
#define MOVE_DIVINE_RAGE         (MOVES_COUNT_GEN9 + 81)
#define MOVE_VANILLA_OOZE       (MOVES_COUNT_GEN9 + 82)
#define MOVE_STRAWBERRY_OOZE    (MOVES_COUNT_GEN9 + 83)
#define MOVE_CHOCOLATE_OOZE     (MOVES_COUNT_GEN9 + 84)
#define MOVE_EARTH_STRIKE       (MOVES_COUNT_GEN9 + 85)
#define MOVE_EARTH_BLAST        (MOVES_COUNT_GEN9 + 86)
#define MOVE_EARTH_WAVE         (MOVES_COUNT_GEN9 + 87)
#define MOVE_EARTH_SURGE        (MOVES_COUNT_GEN9 + 88)
#define MOVE_WATER_STRIKE       (MOVES_COUNT_GEN9 + 89)
#define MOVE_WATER_BLAST        (MOVES_COUNT_GEN9 + 90)
#define MOVE_WATER_WAVE         (MOVES_COUNT_GEN9 + 91)
#define MOVE_WATER_SURGE        (MOVES_COUNT_GEN9 + 92)
#define MOVE_FIRE_STRIKE        (MOVES_COUNT_GEN9 + 93)
#define MOVE_FIRE_BLAST_PS      (MOVES_COUNT_GEN9 + 94)
#define MOVE_FIRE_WAVE          (MOVES_COUNT_GEN9 + 95)
#define MOVE_FIRE_SURGE         (MOVES_COUNT_GEN9 + 96)

#define FIRST_POKESCAPE_MOVE    MOVE_CHAOTIC_RIFT
#define LAST_POKESCAPE_MOVE     MOVE_FIRE_SURGE
